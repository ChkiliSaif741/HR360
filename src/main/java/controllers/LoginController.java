...
public class LoginController implements Initializable {
    ...
    public void loginBtnOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        ServiceUtilisateur serviceUtilisateur = new ServiceUtilisateur();
        Utilisateur utilisateur = serviceUtilisateur.authentifier1(email, password);

        //String CryptedPassword = CryptageUtil.crypterMotDePasse(password);
        if (utilisateur != null /*&& CryptageUtil.verifierMotDePasse(password, CryptedPassword)*/) {

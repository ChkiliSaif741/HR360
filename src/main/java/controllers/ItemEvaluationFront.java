...
public class ItemEvaluationFront {
    ...
    public void setEvaluationFront(AfficheEvaluationFront afficheEvaluationFront) {
   ...
   /* @FXML
    public void showQuiz(MouseEvent mouseEvent) {
        ...
        try {
            ...
            quizController.setAfficheEvaluationFront(this.afficheEvaluationFront);
            quizController.setItemEvaluationFront(this); // Passer l'instance actuelle de ItemEvaluation
   ...
   public void showQuiz(MouseEvent mouseEvent) {
       ...
       try {
           ...
           try {
               ...
               QuizController quizController = controller.loadPage("/QuizView.fxml").getController();

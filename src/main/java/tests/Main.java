...
//            Offre newOffre = new Offre("Développeur Java", "Poste CDI", LocalDateTime.now(), LocalDateTime.now().plusDays(30), String statut);
...
//                    LocalDateTime.now(), "EN ATTENTE", "cv.pdf", "Lettre de motivation", 8 // ID de l'offre associée
//            );

...
public class Main {
    public static void main(String[] args) {
        ...
        Evaluation evaluation = new Evaluation(15.5f, 17.0f, "Bonne prestation", LocalDate.now(), 5, 1);
        Evaluation evaluation2 = new Evaluation(17.5f, 10.0f, "bien", LocalDate.now(), 5, 1);
        ...
        try {
            ...
            System.out.println(serviceEvaluation.afficher());
